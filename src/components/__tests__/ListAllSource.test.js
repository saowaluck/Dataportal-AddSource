...
describe('< ListAllSource />', () => {
  it('should display list of resources according to its props', () => {
    ...
    expect(wrapper.html()).toEqual('<div class="ui row vertical segment">' +
    '<div class="ui segment">' +
    '<div class="ui row vertical segment">' +
    '<div class="ui item">' +
    '<h3 class="ui header">' +
    '<a href="/resources/0/">Track Reseller</a>' +
    '<div class="ui right floated button disabled">' +
    '<div class="visible content">Superset Dashboard' +
    '</div></div></h3></div></div></div>' +
    '<div class="ui segment">' +
    '<div class="ui row vertical segment">' +
    '<div class="ui item">' +
    '<h3 class="ui header">' +
    '<a href="/resources/1/">How to use checkbox of semantic-ui</a>' +
    '<div class="ui right floated button disabled">' +
    '<div class="visible content">Superset Chart' +
    '</div></div></h3></div></div></div></div>')
  })
})
