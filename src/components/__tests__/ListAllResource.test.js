...
describe('< ListAllResource />', () => {
  it('should display list of resources according to its props', () => {
    ...
    '<a href="/resources/137/">Track Reseller</a><div class="ui right floated large button disabled">' +
    '<div class="visible content">Knowledge Post</div></div></h3></div><br/><p><span>' +
    '<i class="empty heart icon"></i>1</span>  <span><a href="/members/136/">' +
    '<i class="user icon people"></i>saowaluck</a></span>  <span>' +
